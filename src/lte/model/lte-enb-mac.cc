...
LteEnbMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LteEnbMac")
    ...
    .AddAttribute ("PrachConfigIndex",
       	           "PRACH Configuration Index that should be used",
       	           UintegerValue (1),
                   MakeUintegerAccessor (&LteEnbMac::m_prachConfigIndex),
...
LteEnbMac::DoGetRachConfig ()
{
  ...
  rc.prachConfigIndex = m_prachConfigIndex;
  return rc;
}
